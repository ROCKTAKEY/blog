...
lastmod = 2020-08-21T19:25:08+09:00
...
`tab-line-mode` では、[Figure 1](#org24b4515)にあるように、
ウィンドウ[^fn:1]
...
{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-line-mode.png" caption="Figure 1: `global-tab-line-mode` をオンにしたEmacs。各ウィンドウにタブ欄がある。" >}}
...
{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-bar-mode.png" caption="Figure 2: `tab-bar-mode` をオンにしたEmacs。ウィンドウは複数あるがタブ欄は1つだけだ。" >}}
...
を返す `tab-bar-tab-name-current` ([Figure 3](#org51fad6a))となっているが、
任意の関数に変更可能。
windowの数を数えて付け加えてくれる `tab-bar-tab-name-current-with-count`
([Figure 4](#orgb0ac3c3))、
長さが `tab-bar-tab-name-truncated-max` を超えると省略してくれる
`tab-bar-tab-name-truncated` ([Figure 5](#orgde16a67))、
表示されている全バッファの名前をカンマで繋げてくれる
`tab-bar-tab-name-all` ([Figure 6](#orgbf0ce28))が用意されている。
自身で作った関数でももちろんOK。

<a id="org51fad6a"></a>

{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-bar-tab-name-current.png" caption="Figure 3: `tab-bar-tab-name-current` のとき(デフォルト)" >}}

<a id="orgb0ac3c3"></a>

{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-bar-tab-name-current-with-count.png" caption="Figure 4: `tab-bar-tab-name-current-with-count` のとき" >}}

<a id="orgde16a67"></a>

{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-bar-tab-name-truncated.png" caption="Figure 5: `tab-bar-tab-name-truncated` のとき" >}}

<a id="orgbf0ce28"></a>

{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-bar-tab-name-all.png" caption="Figure 6: `tab-bar-tab-name-all` のとき" >}}
...
説明があるらしい。(日本語版は(24.5のものだが)[ここ](https://ayatakesi.github.io/emacs/24.5/elisp%5Fhtml/Extended-Menu-Items.html)にある。ほとんどかわっていないので
...
{{< figure src="https://gh-card.dev/repos/ROCKTAKEY/tab-bar-display.svg" >}}
...
{{< figure src="https://raw.githubusercontent.com/ROCKTAKEY/images/netlify/2020-d99103ba-db6f-5424-3053-087c12ab74be/tab-bar-display.png" caption="Figure 7: `tab-bar-display-mode` を用いた例" >}}
...
[^fn:2]: なお、この操作は必須ではない。名前とは矛盾するが、 `tab-bar-mode` がオフでも `tab` 系の関数を使うことができる。
